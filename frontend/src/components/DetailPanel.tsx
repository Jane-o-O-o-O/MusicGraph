...
function formatMetaKey(key: string): string {
  return META_LABELS[key] ?? key.replaceAll("_", " ");
}
      ...
      {entity ? (
        <>
          <div className="detail-grid">
            <div className="detail-item detail-item-strong detail-item-wide">
              <span>名称</span>
            ...
            <div className="detail-item">
              <span>类型</span>
              <strong>{TYPE_LABELS[entity.type] ?? entity.type}</strong>
            </div>
